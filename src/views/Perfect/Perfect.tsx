...
const Perfect = (): JSX.Element => {
  ...
  return (
    <PageTemplate>
      ...
      <Table>
        <Row>
          <Cell centered>
            {t('regular-verbs')}
            <br />
            <img alt="" src={schem1 as string} className={styles.img1} />
            <br />
      ...
      <p className={styles.centered}>
        <img alt="" src={schem2 as string} className={styles.img2} />
      </p>
      <p className={cn(styles.paragraph, styles.centered, styles.cursive)}>
        auf
        <strong>ge</strong>
      ...
      <Table>
        <Row>
          <Cell centered>
            ...
            <br />
            <img alt="" src={schem3 as string} className={styles.img3} />
            <br />
          ...
          <Cell centered>
            ...
            <br />
            <img alt="" src={schem4 as string} className={styles.img3} />
            <br />
            <span className={styles.cursive}>
              <strong>ge</strong>
              kennzeichnet,&nbsp;
      ...
      <img alt="" src={schem5 as string} className={styles.img4} />
      <p className={styles.paragraph}>
