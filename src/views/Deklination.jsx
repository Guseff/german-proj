  ...
  return (
    <PageTemplate>
      <Content className="page-content">
        ...
        <p className="bold">{t('deklination.gens.1')}</p>
        <p className="bold">{t('deklination.gens.2')}</p>
        <p className="bold">{t('deklination.gens.3')}</p>
        <h3 className="centered">{t('1.Feminine.title')}</h3>
        <p className="centered">
        {t('deklination.fem.1')}</p>
        <table className="page-content--table">
          <tbody>
            <tr>
              <td className="low-cell bold-cell">N</td>
              <td className="mid-cell">die Vase</td>
              <td rowspan="4" className="low-cell bold-cell">{t('deklination.fem.2')}</td>
        ...
        <tbody>
            <tr>
              ...
              <td rowspan="4" className="low-cell bold-cell">{t('deklination.s.2')}</td>
        ...
        <h4><u>{t('deklination.s.4')}</u></h4>
        <p>{t('deklination.s.5')}</p>
        <p className="centered cursive">des Sitzes, des Tanzes, des Wunsches</p>
        <p>{t('deklination.s.6')}</p>
        <p className="centered cursive">des Modus, der Kosmos, des Mechanismus</p>
        <p></p>
        ...
        <tbody>
            <tr>
              ...
              <td className="gap-cell" />
              <td rowspan="4" className="low-cell bold-cell centered">{t('deklination.n.2')}</td>
            </tr>
            <tr>
              <td className="low-cell bold-cell">G</td>
            ...
            <tr>
              ...
              <td className="gap-cell" />            </tr>
          </tbody>
        </table>
        <h4 ClassName="centered"><u>{t('deklination.n.5')}</u></h4>
        <p>{t('deklination.n.6')}</p>
        <p className="centered cursive">der Löwe, der Zeuge, der Finne, der Schwede, der Pole, der Belarusse, der Grieche, der Ire, der Schotte, der Affe, der Hase, der Rabe, der Matrose, der Kollege, der Experte, der Heide, der Junge, der Kunde, der Neffe</p>
        <p>{t('deklination.n.7')}</p>
        <p className="red bold">{t('deklination.Leut')}</p>
        <p>{t('deklination.n.8')}</p>
        <p className="centered cursive">der Automat, der Brillant, der Diamant, der Foliant, der Koeffizient, der Komet, der Konsonant, der Paragraf, der Planet u.a.</p>
        <p>{t('deklination.n.9')}</p>
        <p className="centered cursive">der Bär. der Held, der Zar, der Narr, der Prinz, der Mensch, der Tor, der Graf <p></p>+ der Tyrann, der Barbar, der Bauer, der Kamerad, der Vorfahr u.a.</p>
        <h3 className="centered">{t('4.declension.mix.title')}</h3>
        <p className="centered">{t('deklination.mix.1')}</p>
        <p className="centered">der Buchstabe, der Felse(n), der Frieden, der Funke, der Gedanke, der Glaube, der Haufen, der Name, der Samen, der Schaden, der Wille</p>
        <table className="page-content--table">
        <tbody>
            <tr>
              <td className="low-cell bold-cell">N</td>
        ...
        <h3 className="centered">{t('deklination.name')}</h3>
        <table className="page-content--table">
        <tbody>
            <tr>
              <td className="low-cell bold-cell centered">{t('deklination.name.1')}</td>
              <td className="low-cell bold-cell centered">{t('deklination.name.2')}</td>
            </tr>
          </tbody>
        </table>
        <p className="centered cursive">{t('deklination.name.3')}</p>

        <h3 className="centered">{t('deklination.pl.titel')}</h3>
        <p className="centered">{t('deklination.pl.1')}</p>
        <table className="page-content--table">
        <tbody>
            <tr>
              <td className="low-cell bold-cell">N</td>
              ...
              <td rowspan="3" colspan="3" className="low-cell bold-cell centered">{t('deklination.pl.2')}</td>
            </tr>
            <tr>
              <td className="low-cell bold-cell">G</td>
            ...
            <tr>
              ...
              <td className="mid-cell">die Flagen</td>
              <td className="mid-cell">die Fans</td>
              <td className="low-cell cursive centered">Fans, Autos, Wagen, Frauen, Visa</td>
            </tr>
          </tbody>
        </table>
      </Content>
